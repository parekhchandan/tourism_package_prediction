...
Xtrain_path = "hf://datasets/<-----Hugging Face User ID ----->/customer-details/Xtrain.csv"
Xtest_path = "hf://datasets/<-----Hugging Face User ID ----->/customer-details/Xtest.csv"
ytrain_path = "hf://datasets/<-----Hugging Face User ID ----->/customer-details/ytrain.csv"
ytest_path = "hf://datasets/<-----Hugging Face User ID ----->/customer-details/ytest.csv"
...
with mlflow.start_run():
    ...
    repo_id = "Chandan2312/customer-model"
    repo_type = "model"
